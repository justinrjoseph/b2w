			...
			<div class="row" id="primary">
				...
				<div id="content" class="col-sm-12">
					...
					<section class="main-content">
						...
						<p>
							<em>Please keep in mind that some of the following resources are my affiliate links, and should you decide to make a purchase, I will earn a small commission &mdash; at no extra cost to you! I recommend these resources only because I have found them to be incredibly helpful. Don&rsquo;t spend your money on any product or resource unless you think they will benefit you.</em>
						</p>
						...
						<div class="resource-row clearfix">
							<div class="resource">
								...
								<a href="http://bradhussey.ca/justhost" class="btn btn-success">
							...
							<div class="resource">
								...
								<p>
									I use Coda 2 for all of my courses &amp; tutorials, and if you decide to use Coda 2 as your editor of choice, it would greatly benefit you when taking my courses. The price of the editor weighs in at $75, but it&rsquo;s worth every penny &mash; in my honest opinion.
								</p>

								<a href="http://bradhussey.ca/coda2" class="btn btn-success">
									Get out Coda 2
								</a>
							</div><!-- /.resource -->
							...
							<div class="resource">
								...
								<p>
									This tool should go without saying. But if I have to explain &mdash; you need this tool. I use it 24/7 &mdash; literally. Dropbox is where I store my personal &amp; business related data. It&rsquo;s accessible anywhere, and regularly backs up my important information.
								</p>
								
								<p>
									Because my data is accessible anywhere, Dropbox allows me to work on a client project at home, on the bus, in a coffee shop, or at a friend&rsquo;s house. It&rsquo;s truly a gem of a tool, and I think you&rsquo;ll believe me.
								</p>

								<a href="http://bradhussey.ca/dropbox" class="btn btn-success">
									Get started with Justhost
								</a>
							</div><!-- /.resource -->
